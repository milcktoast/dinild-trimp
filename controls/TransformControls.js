...
function TransformGizmoTranslate () {
  ...
  lineXGeometry.addAttribute('position', new Float32Attribute([ 0, 0, 0, 1, 0, 0 ], 3))

  var lineYGeometry = new BufferGeometry()
  lineYGeometry.addAttribute('position', new Float32Attribute([ 0, 0, 0, 0, 1, 0 ], 3))

  var lineZGeometry = new BufferGeometry()
  lineZGeometry.addAttribute('position', new Float32Attribute([ 0, 0, 0, 0, 0, 1 ], 3))
